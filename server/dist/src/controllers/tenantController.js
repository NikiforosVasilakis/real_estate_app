...
exports.RemoveFavoriteProperty = exports.getFavoriteProperty = exports.getCurrentResidencies = exports.updateTenant = exports.createTenant = exports.getTenant = void 0;
...
const getCurrentResidencies = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { cognitoId } = req.params;
        ...
        const residenciesWithFormatedLocation = yield Promise.all(properties.map((property) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
...
exports.getCurrentResidencies = getCurrentResidencies;
const getFavoriteProperty = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { cognitoId, propertyId } = req.params;
        const tenat = yield prisma.tenant.findUnique({
            where: { cognitoId },
            include: { favorites: true },
        });
        const propertyIdNumber = Number(propertyId);
        const existingFavorites = (tenat === null || tenat === void 0 ? void 0 : tenat.favorites) || [];
...
exports.getFavoriteProperty = getFavoriteProperty;
