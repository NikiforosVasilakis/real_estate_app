...
const listApplications = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const formattedApplication = yield Promise.all(applications.map((app) => __awaiter(void 0, void 0, void 0, function* () {
...
const createApplication = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({ message: `Error createing Applications: ${error.message}` });
    }
});
...
const updateApplicationStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({ message: `Error updating Applications: ${error.message}` });
    }
});
